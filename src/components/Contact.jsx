      ...
      <div className="contact-inner">
        ...
        <div className="contact-header">
          ...
          <div className="contact-info">
            <a href={`https://wa.me/${brandInfo.whatsapp}`} className="contact-info-item" target="_blank" rel="noreferrer">
              <span className="info-icon">📱</span>
              <span>WhatsApp Us</span>
            </a>
            <a href={`https://instagram.com/${brandInfo.instagram.replace('@','')}`} className="contact-info-item" target="_blank" rel="noreferrer">
              <span className="info-icon">📷</span>
            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input name="name" type="text" placeholder="e.g. Amara" value={form.name} onChange={handleChange} required />
                </div>
                <div className="form-group">
              ...
              <div className="form-group">
                ...
                <input name="phone" type="tel" placeholder="+94 XX XXX XXXX" value={form.phone} onChange={handleChange} />
              </div>
              <div className="form-group">
                <label>Tell me about your vision</label>
                <textarea name="message" rows="5" placeholder="I'm looking for a custom bracelet with..." value={form.message} onChange={handleChange} required />
              </div>
